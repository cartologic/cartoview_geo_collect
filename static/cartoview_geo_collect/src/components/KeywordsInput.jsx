...
export default class KeywordsInput extends Component {
    state = {
        tags: this.props.keywords ? this.props.keywords.map( ( keyword, i ) => {
    ...
    render( ) {
        ...
        <ReactTags tags={this.state.tags} suggestions={this.state.suggestions} placeholder={'Add a new keyword'} delimiters={[188, 13]} handleDelete={this.handleDelete.bind(this)} handleAddition={this.handleAddition.bind(this)} allowNew={true} autofocus={false}/>
      </div>
        )
    }
}
